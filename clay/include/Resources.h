...
// environment sounds
#define RES_AUDIO_JUNGLE_CLIFF_1              CINDER_RESOURCE( ../resources/audio/, jungle-cliff1.ogg, 300, OGG )
#define RES_AUDIO_JUNGLE_CLIFF_2              CINDER_RESOURCE( ../resources/audio/, jungle-cliff2.ogg, 301, OGG )
#define RES_AUDIO_JUNGLE_1                    CINDER_RESOURCE( ../resources/audio/, jungle1.ogg, 302, OGG )
#define RES_AUDIO_JUNGLE_2                    CINDER_RESOURCE( ../resources/audio/, jungle2.ogg, 303, OGG )
#define RES_AUDIO_ISLANDS_1                   CINDER_RESOURCE( ../resources/audio/, islands1.ogg, 304, OGG )
#define RES_AUDIO_ISLANDS_2                   CINDER_RESOURCE( ../resources/audio/, islands2.ogg, 305, OGG )
#define RES_AUDIO_REDWOOD_1                   CINDER_RESOURCE( ../resources/audio/, redwood1.ogg, 306, OGG )
#define RES_AUDIO_REDWOOD_2                   CINDER_RESOURCE( ../resources/audio/, redwood2.ogg, 307, OGG )
#define RES_AUDIO_DESERT_1                    CINDER_RESOURCE( ../resources/audio/, desert1.ogg, 308, OGG )
#define RES_AUDIO_DESERT_2                    CINDER_RESOURCE( ../resources/audio/, desert2.ogg, 309, OGG )
#define RES_AUDIO_ARCTIC_1                    CINDER_RESOURCE( ../resources/audio/, arctic1.ogg, 310, OGG )
#define RES_AUDIO_ARCTIC_2                    CINDER_RESOURCE( ../resources/audio/, arctic2.ogg, 311, OGG )
#define RES_AUDIO_RIVER_1                     CINDER_RESOURCE( ../resources/audio/, river1.ogg, 312, OGG )
#define RES_AUDIO_RIVER_2                     CINDER_RESOURCE( ../resources/audio/, river2.ogg, 313, OGG )
